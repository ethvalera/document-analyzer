...
public class NegativeCreateTeamBadRequestBase {
    ...
    public void setup() {
        ...
        when(teamService.createTeam(createTeamRequest)).thenThrow(new DocAnalyzerException(HttpStatus.BAD_REQUEST, "The name cannot be empty or null"));
